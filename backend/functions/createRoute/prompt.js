...
5. 徒歩で立ち寄れる場所（公園・神社・広場・店舗など）を選んでください。管理事務所・オフィス・
   立入制限区域など、一般の歩行者が敷地内へ自由に入れない施設は選ばないでください。
6. 出力は指定された【JSONフォーマット】のみとし、マークダウン (\`\`\`json など) や前置き・後書きの文章は一切含めないでください。
